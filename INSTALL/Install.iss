...
#ifdef DiagnosticPackage
  #define MyAppName "SolidWorks To URDF - SW2-3 DIAGNOSTIC"
#else
...
#ifdef DiagnosticPackage
  #define SetupBaseName "sw2urdf_SW2-3_DIAGNOSTIC_"
#else
...
[Files]
#ifdef DiagnosticPackage
Source: {#BuildPlatform + "\" + BuildConfiguration + "\tools\inertia_diagnostics\*"}; DestDir: {app}\tools\inertia_diagnostics; Flags: ignoreversion; Check: IsWin64;
#endif
...
#ifdef DiagnosticPackage
[Icons]
Name: "{autoprograms}\SW2URDF SW2-3 Diagnostic"; Filename: "{sys}\WindowsPowerShell\v1.0\powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -File ""{app}\tools\inertia_diagnostics\Start-InertiaDiagnostic.ps1"""; WorkingDir: "{app}"
#endif
