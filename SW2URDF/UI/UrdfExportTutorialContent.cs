        ...
        private static IList<UrdfExportTutorialStep> BuildChinese()
        {
            return new List<UrdfExportTutorialStep>
            {
                ...
                new UrdfExportTutorialStep(
                    ...
                    "4. STL 目标三角面减面比例：0% 不减面，50% 目标移除一半三角面，100% 在形状保护下最大限度简化，不清空网格。实际减面可能达不到目标；检查轮廓和孔槽，并以导出报告的实际统计为准。\r\n" +
                ...
                new UrdfExportTutorialStep(
                    ...
                    "2. 在 Link 属性页完成颜色、材质、网格格式、碰撞策略和目标三角面减面比例设置。\r\n" +
